...
public class login extends javax.swing.JFrame {
    ...
    /**
     * login sınıfının kurucu metodu. Form elemanlarını oluşturur.
     */
    public login() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1360, 0, 70, 50));
        ...
        jButton4.setText("Sifreyi Unuttum");
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 120, -1, 350));

        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/loginBackground.jpg"))); // NOI18N
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1430, 690));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            // E-posta ve şifreyle eşleşen bir kullanıcı aramak için bir sorgu hazırlar
            ...
            if (rs.next()) {
                // Kullanıcıya başarılı giriş mesajını gösterir
                JOptionPane.showMessageDialog(this, "Giriş Başarılı");
                // Ana sayfaya geçişi sağlarız.
                new homepage().setVisible(true);
            } else {
                // Eğer eşleşen bir kayıt bulunamazsa kullanıcıya hata mesajı gösterir
                JOptionPane.showMessageDialog(this, "Hatalı Şifre veya E-posta");
            }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // Kapatma düğmesine tıklandığında yapılacak işlemler
        ...
        if (yes == JOptionPane.YES_OPTION) {
            // Onaylanırsa uygulamayı kapatır
            System.exit(0);
        }
    ...
    private void lblhideMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lblhideMouseClicked
        // Şifre gizleme simgesine tıklandığında yapılacak işlemler
        if (hidePassword == 0) {
            hidePassword = 1;
            // Şifreyi gizler
            ...
            hidePassword = 0;
            // Şifre gizlemeyi kaldırır
            txtpassword.setEchoChar((char) 0);
        }
    }//GEN-LAST:event_lblhideMouseClicked

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // Kayıt olma düğmesine tıklandığında yeni kayıt ekranını açar
