...
public class loading1 extends javax.swing.JFrame {
    ...
    /**
     * loading1 sınıfının kurucu metodu.
     * Arayüzün başlangıç ayarlarını yapar ve ardından loading2 sınıfının ekranını görüntüler.
     */
    public loading1() {
        initComponents();
        Thread ob = new Thread(new Runnable(){
           ...
           public void run(){
               try {
                    // Arayüzün 1 saniye boyunca görüntülenmesini bekler.
                    Thread.sleep(1000);
                    // loading2 sınıfının ekranını görüntüler.
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1280, 600));
